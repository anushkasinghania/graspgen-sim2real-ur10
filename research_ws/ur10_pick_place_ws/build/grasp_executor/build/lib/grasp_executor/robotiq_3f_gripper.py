...
class RobotiqGripper3F:
    ...
    FORCE_FIRM = 180    # for close (increased: 100 was insufficient to grip real objects)
    ...
    def open(self, speed: int = 200) -> bool:
        ...
        try:
            ...
            time.sleep(2.5)   # wait for motion to complete (increased from 1.5s)
            return True
        except Exception as e:
    ...
    def close(self, force: int = None, speed: int = 200) -> bool:
        ...
        try:
            ...
            time.sleep(2.0)   # wait for motion + contact
            return True
        except Exception as e:
