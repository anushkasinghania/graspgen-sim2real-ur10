...
static const _IndependentControlCommand_type_support_symbol_names_t _IndependentControlCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_3f_interfaces, msg, IndependentControlCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotiq_3f_interfaces, msg, IndependentControlCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotiq_3f_interfaces, msg, IndependentControlCommand)() {
  return &::robotiq_3f_interfaces::msg::rosidl_typesupport_c::IndependentControlCommand_message_type_support_handle;
}
